...
<body>
	<div data-role="page" id="home" class="my-page">
		...
		<?php
			...
			$username = "id7769569_admin";
			$password = "123456";
			$dbname = "id7769569_event";
			...
			if(!$conn){
				...
				if(mysqli_num_rows($result) >0){
					while($row = mysqli_fetch_assoc($result)){
						echo '<li><a href="#"><img src="image/'.$row["Event_Image"].'" alt="" class="ui-li-thumb"><h2>'.$row["Event_Date"].'</h2><p>'.$row["Event_Title"].'</p><p class="ui-li-aside"></p></a></li>';	
